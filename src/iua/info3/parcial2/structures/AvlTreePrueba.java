 ...
 */
public class AvlTreePrueba<AnyType extends Comparable<? super AnyType>> {
    /**
     * Construct the tree.
     */
    public AvlTreePrueba() {
        root = null;
    }
    ...
    /*
     * // Test program public static void main(String[] args) { AvlTree<Integer> t =
     * new AvlTree<>();
     * 
     * for (int i = 0; i < 20; i++) {
     * 
     * t.insert(i); t.printTree(); System.out.println(""); System.out.println(""); }
     * for (int i = 0; i < 20; i++) {
     * 
     * t.remove(i); t.printTree(); System.out.println(""); System.out.println(""); }
     * }
     */
}
